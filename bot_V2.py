...
start_increase = 0.0097 #prend un long si la valeur augmente de x%
start_decrease = 0.0097 #prend un short si la valeur baisse de x%
SP_long = 0.0137 #pourcentage stop loss pour les longs
TP_long = 0.0147 #pourcentage take profit pour les longs
SP_short = 0.0137 #pourcentage stop loss pour les shorts
TP_short = 0.0147 #pourcentage take profit pour les shorts
...
while True:
    ...
    if counter_long != 0 and open_positions == True:
        if price/price_position -1 > 0.006 and change_SP_long_1 == False:
        ...
        elif price/price_position -1 > 0.0072 and change_SP_long_2 == False:
        ...
        elif price/price_position -1 > 0.0082 and change_SP_long_3 == False:
    ...
    if counter_short != 0 and open_positions == True: 
        if -(price/price_position -1) > 0.006 and change_SP_short_1 == False:
        ...
        elif -(price/price_position -1) > 0.0072 and change_SP_short_2 == False:
        ...
        elif -(price/price_position -1) > 0.0082 and change_SP_short_3 == False:
